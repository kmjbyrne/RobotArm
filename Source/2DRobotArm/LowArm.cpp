...
LowArm::LowArm() : ShapeBridge(sf::Vector2<float>(0, 0), sf::Vector2<float>(0, -153))
{
	...
	this->rect->setOrigin(this->rect->getSize().x / 2, this->rect->getSize().y - this->c->getRadius() - 15);
	this->cc = new sf::CircleShape(30);
	this->cc->setOrigin(this->cc->getRadius(), this->cc->getRadius() + this->rect->getSize().y - this->c->getRadius() - 15);
	this->c1 = new sf::CircleShape(22);
	this->c1->setOutlineColor(sf::Color::White);
	this->c1->setOutlineThickness(2);
	this->c1->setOrigin(this->c1->getRadius(), this->c1->getRadius() + this->rect->getSize().y - this->c->getRadius() - 15);
	this->c2 = new sf::CircleShape(16);
	this->c2->setOutlineColor(sf::Color::White);
	this->c2->setOutlineThickness(2);
	this->c2->setOrigin(this->c2->getRadius(), this->c2->getRadius() + this->rect->getSize().y - this->c->getRadius() - 15);
